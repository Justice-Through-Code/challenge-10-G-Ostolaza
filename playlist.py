...
add_song(my_playlist,{'artist': 'Big L', 'title': 'Ebonics'})
...
add_song(my_playlist,{'artist': 'Tupac', 'title': 'California Love'})
add_song(my_playlist,{'artist': 'Biggie', 'title': 'Big Papa'})
